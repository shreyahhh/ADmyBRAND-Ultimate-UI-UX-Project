...
function FeatureCard({ title, description }: { title: string; description: string; }) {
    return (
        ...
        >
            <div className="absolute top-0 left-0 right-0 bottom-0" style={{ clipPath: `path("M 0 303.5 C 0 292.454 8.995 285.101 20 283.5 L 460 219.5 C 470.085 218.033 480 228.454 480 239.5 L 500 430 C 500 441.046 491.046 450 480 450 L 20 450 C 8.954 450 0 441.046 0 430 Z")`, background: 'linear-gradient(306deg, #1f2937, #374151)' }} />
            <motion.div 
                variants={cardVariants} 
                className="w-[200px] h-[280px] bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl flex flex-col justify-center items-center text-center p-4 border border-gray-200"
